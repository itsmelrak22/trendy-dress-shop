<?php
    ...
    <?php
        ...
        $get_completed_orders = "SELECT * FROM customer_orders WHERE order_status='delivered'";
        $run_completed_orders = mysqli_query($con,$get_completed_orders);
        $count_completed_orders = mysqli_num_rows($run_completed_orders);

        $get_total_earnings = "SELECT SUM( due_amount) as Total FROM customer_orders WHERE order_status = 'delivered'";
