...
if(isset($_GET['edit_orders'])) {
    ...
    $edit_order_query = "SELECT po.*, c.customer_name, c.customer_email, c.complete_address FROM customer_orders AS po JOIN customers AS c ON po.customer_id = c.customer_id WHERE po.order_id='$order_id'";
...
if(isset($_POST['update'])) {
    ...
    $update_order_query = "UPDATE customer_orders SET customer_id='$customer_id', invoice_no='$invoice_no', order_status='$order_status' WHERE order_id='$order_id'";
