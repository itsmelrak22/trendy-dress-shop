...
if (isset($_SESSION['searchItem'])) {
    ...
    $query = "SELECT A.*, B.product_img1 as img1 , B.color_id
              ...
              WHERE A.product_title LIKE ? OR B.product_desc LIKE ?
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="row" style="padding: 10px;">
                <?php foreach ($topSalesProducts as $topProduct) : 
                    $colors1 = $conn->prepare("SELECT * FROM `product_colors` WHERE `product_id` = ?");
                    $colors1->bindValue(1, $topProduct['product_id']);
                    $colors1->execute();
                    $colors1_ = $colors1->fetchAll();

                    $display_img1 = "admin_area/product_images/product/" .  $topProduct['product_id'] . "/" . $colors1_[0]["color_name"] . "/" . $colors1_[0]["product_img1"];
                    $display_desc1 = $colors1_[0]["product_desc"];
                    $display_url1 = $colors1_[0]["product_url"];
                ?>
                        ...
                        <div>
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body d-flex justify-content-center">
                                    <img loading="lazy" src="<?= $display_img1 ?>" class="card-image" loding="lazy" />
                                </div>
                                ...
                                <a href="viewProduct_main.php?itemID=<?php echo $topProduct['product_id'] ?>&slug=<?= $display_url1 ?>" style="background-color: black;" class="btn m-2 rounded-pill text-white product_link custom-text">View</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
